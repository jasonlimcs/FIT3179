...
vegaEmbed("#equity", vg_2, {"actions": false}).then(function(result) {
	// Embedded dumbbell chart
}).catch(console.error);

var vg_3 = "dotplot.vl.json";
vegaEmbed("#dotplot", vg_3, {"actions": false}).then(function(result) {
    // Embedded dot plot
}).catch(console.error);

var vg_4 = "stackedbarchart.vl.json";
vegaEmbed("#stacked-bar-chart", vg_4, {"actions": false}).then(function(result) {
    // Embedded stacked bar chart
}).catch(console.error);

var vg_5 = "remoteness.vl.json";
vegaEmbed("#remoteness", vg_5, {"actions": false}).then(function(result) {
